...
//var apiWeatherKey = d81c4f9fc341291a7a3ff0ffde0d6cdb;



//returns latitude and longitude
function latLong(city){
    var geocodeUrl = `https://api.openweathermap.org/geo/1.0/direct?q=` + city + `&limit=5&appid=d81c4f9fc341291a7a3ff0ffde0d6cdb`;
    fetch(geocodeUrl)
...
function currentWeather(city){
    var currentUrl = 'https://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&appid=d81c4f9fc341291a7a3ff0ffde0d6cdb';
    fetch(currentUrl)
        .then(function(response){
            return response.json();
        })
...
function UVApi(){
    var UVUrl = 'https://api.openweathermap.org/data/2.5/onecall?lat=' + lat + '&lon=' + long + '&appid=d81c4f9fc341291a7a3ff0ffde0d6cdb';
    fetch(UVUrl)
        .then(function (response){
            return response.json();
        })
...
function displayCurrentWeather(){
 ...
 function weatherApi(){
    var weatherUrl = 'https://api.openweathermap.org/data/2.5/forecast?lat=' + lat + '&lon=' + long + '&appid=d81c4f9fc341291a7a3ff0ffde0d6cdb';
     fetch(weatherUrl)
         .then(function(response){
             return response.json();
         })
